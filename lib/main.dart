...
void main() async {
  ...
  print('🚀 Iniciando Tienda Online...');
  
  // Inicializar sistema offline-first (incluye la base de datos)
  LocalDatabase? database;
  try {
    await OfflineFirstInitService.instance.initialize();
    database = OfflineFirstInitService.instance.localDatabase;
    print('✅ Sistema offline-first inicializado');
  } catch (e) {
    // Si falla offline-first, usar solo base de datos local
    print('⚠️ Sistema offline-first no disponible: $e');
    print('📱 Continuando en modo normal (solo local)');
...
class RoleSelectionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // Botones flotantes: Sincronización y Migración
      ...
      body: SyncStatusWidget(
        ...
        showProgress: true,
        child: BlocListener<RoleAuthBloc, RoleAuthState>(
